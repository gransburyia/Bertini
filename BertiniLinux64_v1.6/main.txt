...
def makeHomotopyFile(nValue):
    ...
    hFile.write("gamma_t = (gamma) ^ 2 * t + ( 1 - t );\n\n")

    hFile.write("h_t = gamma * t * ( ( b - a ) / n + 1 ) + ( 1 - t ) * ( ( b - a ) / n + 2 );\n\n")
    
    hFile.write("y_1 = ( 1 - t ) * y" + str(nValue + 1) + " + (gamma ^ 2) * beta * t;\n\n")
...
def writeEquations(nValue, fileObject):
    ...
    while(tempValue > 1):
        ...
        fileObject.write("f" + str(nValue - 2) + " = gamma_t * (y" + str(nValue -2) + " - 2 * y" + str(nValue - 1) + " + y" + str(nValue) + ") - (h_t) ^ 2 *(" + newEquation + ");\n")
    ...
    fileObject.write("f" + str(nValue) + " = gamma_t * (y" + str(nValue) + " - 2 * y" + str(nValue + 1) + ") + y_2 - (h_t) ^ 2 * (" + Y_2Equation + ");\n\n") 
